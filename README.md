...
tkinter (aliasként tk)	          Tk(), Listbox(), Menu()	                                    Grafikus felület létrehozása.
tkinter.ttk (aliasként ttk)	      Frame(), Label(), Button(), Entry(), LabelFrame()	          Témázott widgetek a modernebb megjelenésért.
